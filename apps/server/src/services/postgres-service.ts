...
export class PostgresService {
  ...
  async withTransaction<T>(callback: (client: any) => Promise<T>) {
...
function buildPoolConfig(env: Record<string, string | undefined>) {
...
function normalizeSslConfig(rawValue: string | undefined) {
  if (!rawValue) {
    return undefined;
  }
