...
import { StudioDslModal } from './components/studio/StudioDslModal.jsx';
import { StudioPreviewPanel } from './components/studio/StudioPreviewPanel.jsx';
import { StudioSidebar } from './components/studio/StudioSidebar.jsx';
import { StudioThemeProvider } from './components/studio/StudioThemeProvider.jsx';
import { StudioToolbar } from './components/studio/StudioToolbar.jsx';
import { useStudioWorkspace } from './hooks/useStudioWorkspace.js';
    ...
    <StudioThemeProvider>
      <Layout className="studio-root">
        ...
        >
          <StudioSidebar
            collapsed={workspace.sidebarCollapsed}
            onToggle={() => workspace.setSidebarCollapsed((value) => !value)}
            t={workspace.t}
